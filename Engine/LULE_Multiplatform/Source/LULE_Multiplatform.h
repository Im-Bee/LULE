...
#include "Multiplatform/Defs.h"

#ifdef __cplusplus

#	include "Multiplatform/Exception.hpp"

#	include "Utilities/LAllocator.hpp"
#	include "Utilities/LPair.hpp"
#	include "Utilities/LVector.hpp"
#	include "Utilities/LTuple.hpp"

#	include "Multiplatform/AppProperties.hpp"
#	include "Multiplatform/Windows.hpp"
#	include "Multiplatform/IApplication.hpp"
#else // C ---------------------------------------------------------------------
#endif // __cplusplus
